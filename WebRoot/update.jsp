...
<html>
  ...
  <body>
   <%
    ...
    <form action="updatesu.jsp" method="post" class="am-form">
    <%
     String id=request.getParameter("id");
     session.setAttribute("id", id);%>
     <fieldset>
		用户<input type="text" name="name" value="用户" data-validate="required:不能为空,chinese:姓名必须为汉字"
		class="input"  placeholder="用户名称不能包含数字和特殊符号"
		><br>
		<br>
